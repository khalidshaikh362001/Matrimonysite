<?php
    ...
    if($message != "") { // if message box is not empty!
        ...
        // send message
        $sendMessage = "INSERT INTO chat(sent_by,received_by,message,createdAt) VALUES('$sent_by','$received_by','$message','$createdAt')";
        $sendMessageStatus = mysqli_query($conn,$sendMessage) or die(mysqli_error($conn));
        
        if($sendMessageStatus) {

            header("Location: ../chat/message.php?receiver=$received_by");
